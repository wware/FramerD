...
./configure --without-fastcgi --without-tags --enable-shared \
	    "--with-readline=/usr/lib/libreadline.a /usr/lib/libncurses.a" \
            --prefix=/usr --with-config-file=/usr/share/framerd/framerd.cfg \
...
%attr (-,root,root) /usr/lib/libfdtext.so.2
%attr (-,root,root) /usr/lib/libfdscript.so
%attr (-,root,root) /usr/lib/libfdscript.so.4
%attr (-,root,root) /usr/lib/libframerd.so
%attr (-,root,root) /usr/lib/libframerd.so.3
%attr (-,root,root) /usr/lib/libdtypes.so
%attr (-,root,root) /usr/lib/libdtypes.so.4
...
%attr (-,root,root) /usr/include/framerd-2.6/server.h
%attr (-,root,root) /usr/include/framerd-2.6/config.h
%attr (-,root,root) /usr/include/framerd-2.6/strstream.h
%attr (-,root,root) /usr/include/framerd-2.6/search.h
%attr (-,root,root) /usr/include/framerd-2.6/os.h
%attr (-,root,root) /usr/include/framerd-2.6/fdmalloc.h
%attr (-,root,root) /usr/include/framerd-2.6/odb.h
%attr (-,root,root) /usr/include/framerd-2.6/lisp.h
%attr (-,root,root) /usr/include/framerd-2.6/index.h
%attr (-,root,root) /usr/include/framerd-2.6/framerd.h
%attr (-,root,root) /usr/include/framerd-2.6/fdwww.h
%attr (-,root,root) /usr/include/framerd-2.6/fdscript.h
%attr (-,root,root) /usr/include/framerd-2.6/except.h
%attr (-,root,root) /usr/include/framerd-2.6/eval.h
%attr (-,root,root) /usr/include/framerd-2.6/dtypes.h
%attr (-,root,root) /usr/include/framerd-2.6/dtcodes.h
%attr (-,root,root) /usr/include/framerd-2.6/cons.h
%attr (-,root,root) /usr/include/framerd-2.6/common.h
%attr (-,root,root) /usr/include/framerd-2.6/binio.h
