...
(define test
  (lambda (expect fun . args)
    ;; This is a test function which also tests the reader
    (write (cons fun args))
    (display "  ==> ")
    ((lambda (res)
      (write res)
  ...
  ;; Some readers barf at a comment just before the closing paren
  )
(define (report-errs)
  (newline)
...
(define (test-bignum)
  ...
  (test -281474976710655 string->number "-281474976710655")
  (test "-281474976710655" number->string -281474976710655)
  (test -100000000000000010 'big-minus (- (- 100000000000000000) 10))
  (report-errs))
...
(test #t call-with-input-file (get-component "r4rstest.scm") input-port?)
